                                ...
                                <ul class="dropdown-menu pull-right" role="menu">
                                    ...
                                    <li>
                                        <a href="addemployee.php">
                                            <i class="icon-user"></i> Add employee</a>
                                    </li>
                                    <li class="divider"> </li>
                                    <li>
                                        <a href="#">
                                    ...
                                    <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="sample_1">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="none">Start_time</th>
                                                <th class="none">End_time</th>
...
foreach ($result as $row) {
    $role=$row['role_id'];
    $select_role="SELECT * FROM role WHERE id=$role";
    $res_role=$conn->query($select_role);
    $row_role=$res_role->fetch_assoc();
    $position=$row_role['type'];
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="updateemployee.php?do=edit&id=<?php echo $row['id']; ?>"><button class="btn
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a href="function/delete_employee.php?id=<?php echo $row['id']; ?>"><button class="btn btn-danger">Delete</button></a>
      </div>
    </div>
  </div>
</div>
